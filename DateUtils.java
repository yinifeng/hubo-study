package com.cpic.p17.common.utils;
...
public class StringDateUtil {
	...
	public static final int FORMART_KEY_YYYY_MM_DD_HH_MI_SS = 4;
	 ...
	 * @return 操作后的日期
	 */
	public static Timestamp AddHoureTimes(Date startDate, int addnos) {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		if (startDate == null) {
			startDate =new Date();
		}
