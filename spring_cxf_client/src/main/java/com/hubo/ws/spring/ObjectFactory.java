 ...
 * generated in the com.hubo.ws.spring package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetByIdResponse_QNAME = new QName("http://spring.ws.hubo.com/", "getByIdResponse");
    private final static QName _GetById_QNAME = new QName("http://spring.ws.hubo.com/", "getById");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.hubo.ws.spring
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://spring.ws.hubo.com/", name = "getByIdResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://spring.ws.hubo.com/", name = "getById")
